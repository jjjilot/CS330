...
void apply_by_col(void (*func)(char*, int, int, int, int), char*** data, 
                int rows, int cols);
void apply_by_col_test(char* in_str, int row, int col, int rows, int cols);
...
{ 
    ...
    // test capitalize_first_col function
    apply_by_row(capitalize_first_col, data, data_rows, data_cols);
    printf("\nAfter caps:\n");
    apply_by_row(print_str, data, data_rows, data_cols);

    // test apply_by_col using auxiliary test function
    printf("\nTesting apply_by_col:\n");
    apply_by_col(apply_by_col_test, data, data_rows, data_cols);
...
void apply_by_col_test(char* in_str, int row, int col, int rows, int cols) {
    // tests apply_by_col function by printing current row and col as it runs
    printf("I'm in row %d and col %d\n", row, col);
}
